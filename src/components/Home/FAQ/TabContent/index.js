...
const TabContent = ({ id }) => {
  const tabcontents = [
    [
      {
        question: <h5>What is a novel coronavirus?</h5>,
        answer: (
          <div>
            <p>
      ...
      {
        question: <h5>Why is the disease being called coronavirus disease 2019, COVID-19?</h5>,
        answer: (
          <div>
            <p>
              On February 11, 2020 the World Health Organization announced an official name for the
            ...
            <p>
              ...
              illnesses. COVID-19 is a new disease, caused be a novel (or new) coronavirus that has
              not previously been seen in humans. The name of this disease was selected following
              the World Health Organization (WHO) best practiceexternal icon for naming of new human
              infectious diseases.
            </p>
          </div>
        ),
      ...
      {
        question: <h5>How can people help stop stigma related to COVID-19?</h5>,
        answer: (
          <div>
            <p>
              People can fight stigma and help, not hurt, others by providing social support.
              Counter stigma by learning and sharing facts. Communicating the facts that viruses do
              not target specific racial or ethnic groups and how COVID-19 actually spreads can help
              stop stigma.
            </p>
          </div>
        ),
      ...
      {
        question: <h5>Why might someone blame or avoid individuals and groups?</h5>,
        answer: (
          <div>
            <p>
              People in the U.S. may be worried or anxious about friends and relatives who are
              living in or visiting areas where COVID-19 is spreading. Some people are worried about
              the disease. Fear and anxiety can lead to social stigma, for example, towards Chinese
              or other Asian Americans or people who were in quarantine.
            </p>
            <p>
              Stigma is discrimination against an identifiable group of people, a place, or a
              nation. Stigma is associated with a lack of knowledge about how COVID-19 spreads, a
              need to blame someone, fears about disease and death, and gossip that spreads rumors
              and myths.
            </p>
            <p>
    ...
    [
      {
        question: <h5>What is the source of the virus?</h5>,
        answer: (
          <div>
            <p>
              ...
              people. More information about the source and spread of COVID-19 is available on the{' '}
              <a
      ...
      {
        question: <h5>How does the virus spread?</h5>,
        answer: (
          <div>
            <p>
              ...
              person-to-person. It’s important to note that person-to-person spread can happen on a
              continuum. Some viruses are highly contagious (like measles), while other viruses are
              less so.
            </p>
            <p>
      ...
      {
        question: <h5>Can someone who has had COVID-19 spread the illness to others?</h5>,
        answer: (
          <div>
            <p>
              ...
              why CDC recommends that these patients be isolated either in the hospital or at home
              (depending on how sick they are) until they are better and no longer pose a risk of
              infecting others.
            </p>
            <p>
              How long someone is actively sick can vary so the decision on when to release someone
              from isolation is made on a case-by-case basis in consultation with doctors, infection
      ...
      {
        question: <h5>Will warm weather stop the outbreak of COVID-19?</h5>,
        answer: (
          <div>
            <p>
              ...
              months but that does not mean it is impossible to become sick with these viruses
              during other months. At this time, it is not known whether the spread of COVID-19 will
              decrease when weather becomes warmer. There is much more to learn about the
      ...
      },
      {
        question: (
          <h5>
            Can the virus that causes COVID-19 be spread through food, including refrigerated or
            frozen food?
          </h5>
        ),
        answer: (
          <div>
            <p>
              ...
              always wash your hands with soap and water for 20 seconds for general food safety.
              Throughout the day wash your hands after blowing your nose, coughing or sneezing, or
      ...
      {
        question: <h5>What is community spread?</h5>,
        answer: (
          <div>
            <p>
    ...
    [
      {
        question: <h5>What can I do to protect myself and prevent the spread of disease?</h5>,
        answer: (
          <div>
            ...
            <ul className={styles[`list-dot`]}>
              <li>
                ...
                <br />
                <strong>Why?</strong> Washing your hands with soap and water or using alcohol-based
              ...
              <li>
                ...
                <br />
                <strong>Why?</strong> When someone coughs or sneezes they spray small liquid
                droplets from their nose or mouth which may contain virus. If you are too close, you
                can breathe in the droplets, including the COVID-19 virus if the person coughing has
                the disease.
              </li>
              <li>
                Avoid touching eyes, nose and mouth.
                <br />
                <strong>Why?</strong> Hands touch many surfaces and can pick up viruses. Once
              ...
              <li>
                ...
                <br />
                <strong>Why?</strong> Droplets spread virus. By following good respiratory hygiene
              ...
              <li>
                ...
                health authority.
                <br />
                <strong>Why?</strong> National and local authorities will have the most up to date
                information on the situation in your area. Calling in advance will allow your health
                care provider to quickly direct you to the right health facility. This will also
              ...
              <li>
                ...
                <br />
                <strong>Why?</strong> You have a higher chance of catching COVID-19 in one of these
                areas.
              </li>
            </ul>
          </div>
      ...
      {
        question: <h5>What should I do if I had close contact with someone who has COVID-19?</h5>,
        answer: (
          <div>
            <p>
              Household members, intimate partners, and caregivers in a nonhealthcare setting may
              have close contact2 with a person with symptomatic, laboratory-confirmed COVID-19 or a
              person under investigation. Close contacts should monitor their health; they should
              call their healthcare provider right away if they develop symptoms suggestive of
              COVID-19 (e.g., fever, cough, shortness of breath)
            </p>
            ...
            <ul className={styles[`list-dot`]}>
              <li>
                ...
                provider’s instructions for medication(s) and care. You should help the patient with
                basic needs in the home and provide support for getting groceries, prescriptions,
                and other personal needs.
              </li>
              <li>
                Monitor the patient’s symptoms. If the patient is getting sicker, call his or her
                ...
                people in the office or waiting room from getting infected. Ask the healthcare
                provider to call the local or state health department for additional guidance. If
                the patient has a medical emergency and you need to call 911, notify the dispatch
                personnel that the patient has, or is being evaluated for COVID-19.
              </li>
              <li>
                Household members should stay in another room or be separated from the patient as
                much as possible. Household members should use a separate bedroom and bathroom, if
                available.
              </li>
              <li>Prohibit visitors who do not have an essential need to be in the home.</li>
              <li>
                Household members should care for any pets in the home. Do not handle pets or other
                animals while sick.&nbsp; For more information, see{' '}
                <a
              ...
              <li>
                Perform hand hygiene frequently. Wash your hands often with soap and water for at
                least 20 seconds or use an alcohol-based hand sanitizer that contains 60 to 95%
                alcohol, covering all surfaces of your hands and rubbing them together until they
                feel dry. Soap and water should be used preferentially if hands are visibly dirty.
              </li>
              <li>Avoid touching your eyes, nose, and mouth with unwashed hands.</li>
              <li>
                The patient should wear a facemask when you are around other people. If the patient
                is not able to wear a facemask (for example, because it causes trouble breathing),
                you, as the caregiver, should wear a mask when you are in the same room as the
                patient.
              </li>
              <li>
                Wear a disposable facemask and gloves when you touch or have contact with the
                patient’s blood, stool, or body fluids, such as saliva, sputum, nasal mucus, vomit,
                urine.
                <ul>
              ...
              <li>
                ...
                drinking glasses, cups, eating utensils, towels, bedding, or other items. After the
                patient uses these items, you should wash them thoroughly (see below “Wash laundry
                thoroughly”).
              </li>
              <li>
              ...
              <li>
                ...
                <ul>
                  <li>
                    Immediately remove and wash clothes or bedding that have blood, stool, or body
                    fluids on them.
                  </li>
                  <li>
                    Wear disposable gloves while handling soiled items and keep soiled items away
                    from your body. Clean your hands (with soap and water or an alcohol-based hand
                    sanitizer) immediately after removing your gloves.
                  </li>
                  <li>
                    Read and follow directions on labels of laundry or clothing items and detergent.
                    In general, using a normal laundry detergent according to washing machine
              ...
              <li>
                ...
                (with soap and water or an alcohol-based hand sanitizer) immediately after handling
                these items. Soap and water should be used preferentially if hands are visibly
                dirty.
              </li>
              <li>
      ...
      {
        question: <h5>Who is at higher risk for serious illness from COVID-19?</h5>,
        answer: (
          <div>
            <p>
              <strong>
              ...
              may be at higher risk for more serious complications from COVID-19. These people who
              may be at higher risk of getting very sick from this illness, includes:
            </p>
            <ul className={styles[`list-dot`]}>
              <li>
              ...
              <li>
                <strong>People who have serious underlying medical conditions</strong> like:
                <ul>
                  <li>Heart disease</li>
                  <li>Diabetes</li>
                  <li>Lung disease</li>
      ...
      {
        question: <h5>What should people at higher risk of serious illness with COVID-19 do?</h5>,
        answer: (
          <div>
            <p>
              ...
              you go out in public, keep away from others who are sick; limit close contact and wash
              your hands often; and avoid crowds, cruise travel, and non-essential travel. If there
              is an outbreak in your community, stay home as much as possible. Watch for symptoms
              and emergency signs. If you get sick, stay home and call your doctor. More information
              on how to prepare, what to do if you get sick, and how communities and caregivers can
              support those at higher risk is available on{' '}
              <a
      ...
      {
        question: <h5>Should I wear a mask to protect myself?</h5>,
        answer: (
          <div>
            <p>
              Only wear a mask if you are ill with COVID-19 symptoms (especially coughing) or
              looking after someone who may have COVID-19. Disposable face mask can only be used
            ...
            <p>
              ...
              resources and mis-use of masks (
              <a
    ...
    [
      {
        question: <h5>What are the symptoms of COVID-19?</h5>,
        answer: (
          <div>
            <p>
              ...
              recover from the disease without needing special treatment. Around 1 out of every 6
              people who gets COVID-19 becomes seriously ill and develops difficulty breathing.
              Older people, and those with underlying medical problems like high blood pressure,
              heart problems or diabetes, are more likely to develop serious illness. People with
      ...
      {
        question: <h5>Should I be tested for COVID-19?</h5>,
        answer: (
          <div>
            <p>
              Not everyone needs to be tested for COVID-19. For information about testing, see{' '}
              <a
      ...
      {
        question: <h5>Where can I get tested for COVID-19?</h5>,
        answer: (
          <div>
            <p>
              ...
              medical provider. State and local public health departments have received tests from
              CDC while medical providers are getting tests developed by commercial manufacturers.
      ...
      {
        question: <h5>Can a person test negative and later test positive for COVID-19?</h5>,
        answer: (
          <div>
            <p>
            ...
            <p>
              ...
              symptoms likely means that the COVID-19 virus is not causing their current illness.
            </p>
          </div>
        ),
      },
    ...
    [
      {
        question: <h5>What should I do if there is an outbreak in my community?</h5>,
        answer: (
          <div>
            <p>
            ...
            <ul className={styles[`list-dot`]}>
              <li>
                <strong>Stay informed about the local COVID-19 situation</strong>. Be aware of
                temporary school dismissals in your area, as this may affect your household’s daily
                routine.
              </li>
              <li>
                <strong>Continue practicing everyday preventive actions. </strong>Cover coughs and
                sneezes with a tissue and wash your hands often with soap and water for at least 20
                seconds. If soap and water are not available, use a hand sanitizer that contains 60%
                alcohol. Clean frequently touched surfaces and objects daily using a regular
              ...
              <li>
                ...
                Ask to work from home or take leave if you or someone in your household gets sick
                with
                <a
              ...
              <li>
                <strong>Stay in touch with others by phone or email. </strong>If you have a chronic
      ...
      {
        question: (
          <h5>How do I prepare my children in case of COVID-19 outbreak in our community?</h5>
        ),
        answer: (
          <div>
            <p>
      ...
      {
        question: (
          <h5>What steps should parents take to protect children during a community outbreak?</h5>
        ),
        answer: (
          <div>
            <p>
              This is a new virus and we are still learning about it, but so far, there does not
              seem to be a lot of illness in children. Most illness, including serious illness, is
            ...
            <p>
              ...
              school. Talk with teachers about classroom assignments and activities they can do from
      ...
      {
        question: <h5>Will schools be dismissed if there is an outbreak in my community?</h5>,
        answer: (
          <div>
            <p>
              Depending on the situation, public health officials may recommend community actions to
              reduce exposures to COVID-19, such as school dismissals. Read or watch local media
              sources that report school dismissals or and watch for communication from your child’s
              school. If schools are dismissed temporarily, discourage students and staff from
              gathering or socializing anywhere, like at a friend’s house, a favorite restaurant, or
      ...
      {
        question: <h5>Should I go to work if there is an outbreak in my community?</h5>,
        answer: (
          <div>
            <p>
              ...
              , or if your child’s school is dismissed temporarily. Employers should be aware that
              more employees may need to stay at home to care for sick children or other sick family
              members than is usual in case of a community outbreak.
            </p>
          </div>
        ),
      },
    ...
    [
      {
        question: <h5>COVID-19 virus can be transmitted in areas with hot and humid climates?</h5>,
        answer: (
          <div>
            <p>
              ...
              protect yourself against COVID-19 is by frequently cleaning your hands. By doing this
              you eliminate viruses that may be on your hands and avoid infection that could occur
      ...
      {
        question: <h5>Cold weather and snow CANNOT kill the new coronavirus</h5>,
        answer: (
          <div>
            <p>
              ...
              of the external temperature or weather. The most effective way to protect yourself
              against the new coronavirus is by frequently cleaning your hands with alcohol-based
              hand rub or washing them with soap and water.
            </p>
          </div>
        ),
      },
      {
        question: <h5>Taking a hot bath does not prevent the new coronavirus disease</h5>,
        answer: (
          <div>
            <p>
              ...
              or shower. Actually, taking a hot bath with extremely hot water can be harmful, as it
              can burn you. The best way to protect yourself against COVID-19 is by frequently
      ...
      {
        question: <h5>The new coronavirus CANNOT be transmitted through mosquito bites.</h5>,
        answer: (
          <div>
            <p>
      ...
      {
        question: <h5>Are hand dryers effective in killing the new coronavirus?</h5>,
        answer: (
          <div>
            <p>
              ...
              alcohol-based hand rub or wash them with soap and water. Once your hands are cleaned,
      ...
      {
        question: <h5>Can an ultraviolet disinfection lamp kill the new coronavirus?</h5>,
        answer: (
          <div>
            <p>
      ...
      {
        question: <h5>Do vaccines against pneumonia protect you against the new coronavirus?</h5>,
        answer: (
          <div>
            <p>
            ...
            <p>
              ...
              trying to develop a vaccine against 2019-nCoV, and WHO is supporting their efforts.
            </p>
            <p>
