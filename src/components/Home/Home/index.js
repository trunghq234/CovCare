        ...
        <Row gutter={[64, 0]}>
          ...
          <Col className={styles['col1']} lg={12}>
            <div className={styles['home__data']}>
              ...
              <p>
                The Coronavirus (COVID-19) lần đầu tiên được báo cáo xuất hiện tại Vũ Hán, Hồ Bắc,
                Trung Quốc vào tháng 12 2019, đợt bùng phát sau đó đã được tổ chức Y tế Thế giới
                (WHO) công nhận là đại dịch vào ngày 11 tháng 3 năm 2020.
              </p>
              ...
              <div className={styles['status']}>
                <Row>
                  ...
                  <Col xs={12} sm={8} className={styles['status__content']}>
                    <div className={styles['status__item']}>
                      <h6 className={styles['title']}>Số lượng người mất</h6>
                      <p className={styles['covid-stats-cases']}>5,370,192</p>
                    </div>
                  </Col>
                  <Col xs={12} sm={8} className={styles['status__content']}>
                    <div className={styles['status__item']}>
                      <h6 className={styles['title']}>Số lượng người được cứu sống</h6>
