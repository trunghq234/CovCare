        ...
        <Col className={styles['col1']} lg={12}>
          <div className={styles['home__data']}>
            ...
            <p>
              ...
              Quốc vào tháng 12 2019, đợt bùng phát sau đó đã được tổ chức Y tế Thế giới (WHO) công
              nhận là đại dịch vào ngày 11 tháng 3 năm 2020.
            </p>
            <ul className={styles['btns']}>
              <li>
                <a className="btn" href="#prevention">
                  Cách để tự bảo vệ
                  <i class="fas fa-shield-alt"></i>
                </a>
              </li>
              <li>
                <a className="btn btn__transparent" href="#about">
              ...
              <Row>
                <Col xs={12} sm={8} className={styles['status__content']}>
                  <div className={styles['status__item']}>
                    <h6 className={styles['title']}>Số ca nhiễm</h6>
